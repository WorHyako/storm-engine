...
void TButterflies::LoadSettings()
{
    ...
    butterfliesCount = config.get<int>(ANIMALS_BUTTERFLIES_SECTION, "count", BUTTERFLY_COUNT);
    maxDistance = config.get<int>(ANIMALS_BUTTERFLIES_SECTION, "distance", BUTTERFLY_DISTANCE);
